...
model = load_lua('../data/alexnet_BWN_cpu.t7' if BWN else '../data/alexnet_XNOR_cpu.t7', unknown_classes=True)
...
img = (imread('../images/laska.png')[:,:,:3]).astype(np.float32)

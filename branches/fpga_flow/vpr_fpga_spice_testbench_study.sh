...
# SRAM FPGA
# TT case 
perl fpga_flow.pl -conf ../configs/sample.conf -benchmark ../benchmarks/RelChip_verilog_bench.txt -rpt ../csv_rpts/fpga_spice/k6_N10_MD_sram_tsmc40nm_chain_TT.csv -N 10 -K 6 -ace_d 0.5 -power -remove_designs -multi_thread 1 -vpr_fpga_spice ../vpr_fpga_spice_task_lists/k6_N10_sram_tsmc40nm -vpr_fpga_spice_rename_illegal_port -vpr_fpga_spice_sim_mt_num 20  -vpr_fpga_spice_print_component_tb -vpr_fpga_spice_print_grid_tb -vpr_fpga_spice_print_top_tb #-vpr_fpga_spice_testbench_load_extraction_off -vpr_fpga_spice_parasitic_net_estimation_off #-vpr_fpga_spice_leakage_only  

#perl run_fpga_spice.pl -conf ../vpr_fpga_spice_conf/sample.conf -task ../vpr_fpga_spice_task_lists/k6_N10_sram_tsmc40nm_standard.txt -rpt ../vpr_fpga_spice_csv_rpts/k6_N10_sram_tsmc40_spice_bench_TT.csv -multi_thread 2 -parse_pb_mux_tb -parse_cb_mux_tb -parse_sb_mux_tb -parse_lut_tb -parse_hardlogic_tb -parse_grid_tb -parse_cb_tb -parse_sb_tb -parse_top_tb
cd ..

# Sweep Corner Cases 
set corner_list = (MC)
#set corner_list = (FF SS MC)

...
# Synchronize for RRAM-based FPGA at nominal voltage 
set rhrs_list = (100 500)
foreach j ($rhrs_list)
  # Duplicate 
  cp k6_N10_rram_tsmc40nm_nearVt0p8V_RHRS30MOhm.xml k6_N10_rram_tsmc40nm_nearVt0p8V_RHRS$j\MOhm.xml
  # replace with the new numbers 
  sed -i 's/roff=\"30e6\"/roff=\"'${j}'e6\"/g' k6_N10_rram_tsmc40nm_nearVt0p8V_RHRS$j\MOhm.xml
end

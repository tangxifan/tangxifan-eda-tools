...
void InitSpiceStimulateParams(t_spice_stimulate_params* stimulate_params) {
  /* Clocks */ 
  stimulate_params->clock_slew_pct_rise = 0.1;
  stimulate_params->clock_slew_pct_fall = 0.1;
  stimulate_params->clock_freq = 0.;
  stimulate_params->sim_clock_freq_slack = 0.2;
  /* inputs */
  stimulate_params->input_slew_pct_rise = 0.1;
  stimulate_params->input_slew_pct_fall = 0.1;

...
t_opt_info vpr_versapower_opts[] = {
  ...
  {"power_properties", 0, OPT_WITHVAL, OPT_CHAR, OPT_REQ, OPT_NONDEF, "Specify the power property XML file"},
  {"power_report_file", 0, OPT_WITHVAL, OPT_CHAR, OPT_OPT, OPT_NONDEF, "Specify the output power report file name"},

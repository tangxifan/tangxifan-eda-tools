...
#./vpr ./ARCH/k6_N10_sram_tsmc40nm_mem_TT.xml Circuits/ch_intrinsics_prevpr.blif --full_stats --nodisp --activity_file Circuits/ch_intrinsics_prevpr.act --fpga_verilog --fpga_verilog_dir ./sram_fpga_hetero --fpga_spice_rename_illegal_port --route_chan_width 100

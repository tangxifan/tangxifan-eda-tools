...
# SRAM MUXes
#perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/local_routing.conf -rpt results/tsmc40nm_fpga/local_routing_mux50.csv -mux spice/subvt_lut.sp -mux_size 50 -two_level_mux cpt -w_cpt_sweep 3
perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/sb_route.conf -rpt results/tsmc40nm_fpga/sbmux4.csv -mux spice/subvt_lut.sp -mux_size 4 -auto_out_tapered_buffer 3 -two_level_mux cpt -w_cpt_sweep 3

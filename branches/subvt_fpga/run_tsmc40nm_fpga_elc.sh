...
# SRAM MUXes
#perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/rram_mux_sample.conf -rpt results/tsmc40nm_fpga/mux2.csv -mux spice/subvt_lut.sp -mux_size 2 -two_level_mux cpt
...
perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/cb_route.conf -rpt results/tsmc40nm_fpga/cbmux48_fci0p15.csv -mux spice/subvt_lut.sp -mux_size 48 -auto_out_tapered_buffer 3 -two_level_mux cpt
...
perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/ble_mux2_fco0p1.conf -rpt results/tsmc40nm_fpga/blemux2_fco0p1.csv -mux spice/subvt_lut.sp -mux_size 2 -auto_out_tapered_buffer 3 -one_level_mux cpt
...
# RRAM FPGA
#perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/rram_mux_sample.conf -rpt results/tsmc40nm_fpga/rram_local_routing_mux32.csv -mux spice/subvt_lut.sp -mux_size 32 -one_level_mux prog_pair -rram_enhance -wprog_sweep 3 -rram_mux_dvc 
perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/rram_local_routing.conf -rpt results/tsmc40nm_fpga/rram_local_routing_mux53.csv -mux spice/subvt_lut.sp -mux_size 2 -one_level_mux prog_pair -rram_enhance -wprog_sweep 2 
perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/rram_sb_route.conf -rpt results/tsmc40nm_fpga/rram_sbmux4.csv -mux spice/subvt_lut.sp -mux_size 4 -one_level_mux prog_pair -rram_enhance -wprog_sweep 2 -auto_out_tapered_buffer 4
perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/rram_sb_route_ideal.conf -rpt results/tsmc40nm_fpga/rram_sbmux4_zeroload.csv -mux spice/subvt_lut.sp -mux_size 4 -one_level_mux prog_pair -rram_enhance -wprog_sweep 2 -auto_out_tapered_buffer 4
...
perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/rram_cb_route.conf -rpt results/tsmc40nm_fpga/rram_cbmux120_fci1.csv -mux spice/subvt_lut.sp -mux_size 120 -one_level_mux prog_pair -rram_enhance -wprog_sweep 2 -auto_out_tapered_buffer

# Fc,out = 0.1, 0.25, 0.5, 0.75, 1
perl subvt_fpga_elc.pl -conf conf/tsmc40nm_fpga/rram_ble_mux2_fco0p1.conf -rpt results/tsmc40nm_fpga/rram_blemux2_fco0p1.csv -mux spice/subvt_lut.sp -mux_size 2 -one_level_mux prog_pair -rram_enhance -wprog_sweep 2 -auto_out_tapered_buffer 3

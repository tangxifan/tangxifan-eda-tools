...
% Naive 4T1R MUX
rram_mux_naive_1level_parasitic_fig_data_tsmc40nm
rram_mux_naive_1level_0p9V_3fin = rram_mux_naive_1level_0p9V(1:1:end,:); 

%% Naive design with 2N1R structure  
rram_mux_improv_2n1r_1level_fig_data_tsmc40nm
rram_mux_naive_2n1r_1level_0p9V_3fin = rram_mux_naive_2n1r_1level_0p9V(1:1:end,:); 
...
for isize = 1:1:num_swept_input_size 
  for iVDD = 1:1:num_VDD
    % In terms of best delay 
    % Form a matrix comparing 1-level and 2-level performance
    temp = [rram_mux_1level_best_delay(:,isize,iVDD); 
			rram_mux_2level_best_delay(:,isize,iVDD);]; 
    [best_delay, best_delay_index] = min(temp(:,3)); % the 3rd column is the delay 
    rram_mux_best_delay(:, isize, iVDD) = temp(best_delay_index,:);
    % In terms of best power
    % Form a matrix comparing 1-level and 2-level performance
    temp = [rram_mux_1level_best_power(:,isize,iVDD); 
			rram_mux_2level_best_power(:,isize,iVDD);]; 
    [best_power, best_power_index] = min(temp(:,5)); % the 5th column is the power
    rram_mux_best_power(:, isize, iVDD) = temp(best_power_index,:);
    % In terms of best pdp
    % Form a matrix comparing 1-level and 2-level performance
    temp = [rram_mux_1level_best_pdp(:,isize,iVDD); 
			rram_mux_2level_best_pdp(:,isize,iVDD);]; 
    [best_pdp, best_pdp_index] = min(temp(:,6)); % the 6th column is the PDP
...
plot(wprog_list, sram_mux_best_delay(3,8,3)/1e-12 * ones(wprog_list),'k-o','LineWidth', 2, 'MarkerSize',10);
% 1-level 4T1R MUX, VDD = 0.9V, input size = 16   
plot(wprog_list, rram_mux_improve_1level_xl(3,:,8,3)/1e-12,'r-*','LineWidth', 2, 'MarkerSize',10);
% 2-level 4T1R MUX, VDD = 0.9V, input size = 16   
plot(wprog_list, rram_mux_improve_2level_xl(3,:,8,3)/1e-12,'b-+','LineWidth', 2, 'MarkerSize',10);
% tree-level 4T1R MUX, VDD = 0.9V, input size = 16   
plot(wprog_list, rram_mux_improve_tree_xl(3,:,8,3)/1e-12,'g-s','LineWidth', 2, 'MarkerSize',10);
...
fig_handle3 = figure;
% best SRAM MUX, VDD = 0.9V, in terms of delay
plot(wprog_list, sram_mux_best_delay(5,8,3)/1e-12 * ones(wprog_list),'k-o','LineWidth', 2, 'MarkerSize',10);
% 1-level 4T1R MUX, VDD = 0.9V, input size = 16   
...
plot(mux_size_list, rram_mux_improve_1level_best_delay(2,:,3)/1e-12,'r-*','LineWidth', 2, 'MarkerSize',10);
hold on
% 2-level 4T1R MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, rram_mux_improve_2level_best_delay(2,:,3)/1e-12,'b-+','LineWidth', 2, 'MarkerSize',10);
hold on
% tree-like 4T1R MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, rram_mux_improve_tree_best_delay(2,:,3)/1e-12,'g-s','LineWidth', 2, 'MarkerSize',10);
hold on
...
plot(mux_size_list, rram_mux_improve_1level_best_delay(2,:,1)/1e-12,'r-*','LineWidth', 2, 'MarkerSize',10);
hold on
% 1-level 4T1R MUX, VDD = 0.8V, in terms of delay
plot(mux_size_list, rram_mux_improve_1level_best_delay(2,:,2)/1e-12,'b-+','LineWidth', 2, 'MarkerSize',10);
hold on
% 1-level 4T1R MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, rram_mux_improve_1level_best_delay(2,:,3)/1e-12,'g-s','LineWidth', 2, 'MarkerSize',10);
hold on
%title('Delay (ps) and MUX size N','FontSize',18)
xlabel('MUX size','FontSize',16, 'FontWeight','bold', 'FontName', 'Times');
ylabel('W_{prog} (Minimum Transistor Width)','FontSize',18, 'FontWeight','bold', 'FontName', 'Times');
...
%set(gca,'ylim',[10 22],'Fontsize',16, 'FontWeight','bold', 'FontName', 'Times');
set(gca, 'Fontsize',16, 'FontWeight','bold', 'FontName', 'Times');
hleg = legend([{'Improv. 1-level 4T1R MUX (V_{DD}=0.7V)'}, {'Improv. 1-level 4T1R MUX (V_{DD}=0.7V)'}, {'Improv. 1-level 4T1R MUX (V_{DD}=0.7V)'}]);
...
fig_handle6 = figure;
% best SRAM MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, sram_mux_best_delay(3,:,3)/1e-12,'k-o','LineWidth', 2, 'MarkerSize',10);
...
plot(mux_size_list, rram_mux_improve_2level_xl_best_delay(3,:,3)/1e-12,'g-s','LineWidth', 2, 'MarkerSize',10);
hold on
%title('Delay (ps) and MUX size N','FontSize',18)
xlabel('MUX size','FontSize',16, 'FontWeight','bold', 'FontName', 'Times');
ylabel('W_{prog} (Minimum Transistor Width)','FontSize',18, 'FontWeight','bold', 'FontName', 'Times');
...
hold on
% Naive 1-level 2N1R MUX, VDD=0.9V, in terms of delay
plot(mux_size_list, rram_mux_naive_2n1r_1level_0p7V_3fin(:,3)/1e-12,'m-^','LineWidth', 2, 'MarkerSize',10);
hold on
% Naive 1-level 4T1R MUX, VDD=0.9V, in terms of delay
plot(mux_size_list, rram_mux_naive_1level_0p7V_3fin(:,3)/1e-12,'c-<','LineWidth', 2, 'MarkerSize',10);
hold on
%title('Delay (ps) and MUX size N','FontSize',18)
xlabel('MUX size','FontSize',16, 'FontWeight','bold', 'FontName', 'Times');
ylabel('Delay (ps)','FontSize',18, 'FontWeight','bold', 'FontName', 'Times');
...
%set(gca,'ylim',[10 22],'Fontsize',16, 'FontWeight','bold', 'FontName', 'Times');
set(gca, 'Fontsize',16, 'FontWeight','bold', 'FontName', 'Times');
hleg = legend([{'CMOS MUX'}, {'Improv. 1-level 4T1R MUX'}, {'Improv. 2-level 4T1R MUX'}, {'Improv. tree-like 4T1R MUX'}, {'Naive 1-level 2T1R MUX'}, {'Naive 1-level 4T1R MUX'}]);
...
plot(mux_size_list, sram_mux_best_delay(3,:,1)/1e-12,'c-s','LineWidth', 2, 'MarkerSize',10);
hold on
% best SRAM MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, sram_mux_best_delay(3,:,3)/1e-12,'k-o','LineWidth', 2, 'MarkerSize',10);
hold on
...
set(gca, 'Fontsize',16, 'FontWeight','bold', 'FontName', 'Times');
hleg = legend([{'CMOS MUX (V_{DD}=0.7V)'}, {'CMOS MUX (V_{DD}=0.9V)'}, {'1-level 4T1R MUX (V_{DD}=0.7V)'}, {'1-level 4T1R MUX (V_{DD}=0.8V)'}, {'1-level 4T1R MUX (V_{DD}=0.8V)'}]);
...
fig_handle10 = figure;
% best SRAM MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, sram_mux_best_delay(3,:,3).* sram_mux_best_delay(5,:,3)/1e-15,'k-o','LineWidth', 2, 'MarkerSize',10);
hold on
% 1-level 4T1R MUX, VDD = 0.9V, in terms of delay
...
hold on
% Naive 1-level 2N1R MUX, VDD=0.9V, in terms of delay
plot(rram_mux_naive_2n1r_1level_0p7V_3fin(:,1), rram_mux_naive_2n1r_1level_0p7V_3fin(:,3).*rram_mux_naive_2n1r_1level_0p7V_3fin(:,5)/1e-15,'m-^','LineWidth', 2, 'MarkerSize',10);
hold on
% Naive 1-level 4T1R MUX, VDD=0.9V, in terms of delay
plot(rram_mux_naive_1level_0p7V_3fin(:,1), rram_mux_naive_1level_0p7V_3fin(:,3).*rram_mux_naive_1level_0p7V_3fin(:,5)/1e-15,'c-<','LineWidth', 2, 'MarkerSize',10);
hold on
...
fig_handle11 = figure;
% best SRAM MUX, VDD = 0.7V, in terms of delay
plot(mux_size_list, sram_mux_best_delay(5,:,1)/1e-6,'c-s','LineWidth', 2, 'MarkerSize',10);
hold on
% best SRAM MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, sram_mux_best_delay(5,:,3)/1e-6,'k-o','LineWidth', 2, 'MarkerSize',10);
hold on
% 1-level 4T1R MUX, VDD = 0.7V, in terms of delay
...
hold on
% 1-level 4T1R MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, rram_mux_improve_1level_best_delay(5,:,2)/1e-6,'g-s','LineWidth', 2, 'MarkerSize',10);
hold on
...
adp_best_sram_mux_0p9V = sram_mux_best_delay(1,:,3).*sram_mux_best_delay(3,:,3)/1e-12;
...
fig_handle12 = figure;
% best SRAM MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, adp_sram_mux_0p9V,'k-o','LineWidth', 2, 'MarkerSize',10);
hold on
% best 4T1R MUX, VDD = 0.7V, in terms of delay
plot(mux_size_list, adp_rram_mux_0p7V,'b-*','LineWidth', 2, 'MarkerSize',10);
hold on
% best 4T1R MUX, VDD = 0.8V, in terms of delay
plot(mux_size_list, adp_rram_mux_0p8V,'g-s','LineWidth', 2, 'MarkerSize',10);
hold on
% best 4T1R MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, adp_rram_mux_0p9V,'r-+','LineWidth', 2, 'MarkerSize',10);
hold on
...
pdp_best_sram_mux_0p9V = (sram_mux_best_delay(3,:,3)/1e-12).*sram_mux_best_delay(5,:,3)/1e-3;
...
fig_handle9 = figure;
% best SRAM MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, pdp_sram_mux_0p7V,'k-o','LineWidth', 2, 'MarkerSize',10);
hold on
% best 4T1R MUX, VDD = 0.7V, in terms of delay
plot(mux_size_list, pdp_rram_mux_0p7V,'b-*','LineWidth', 2, 'MarkerSize',10);
hold on
% best 4T1R MUX, VDD = 0.8V, in terms of delay
plot(mux_size_list, pdp_rram_mux_0p8V, 'r-+','LineWidth', 2, 'MarkerSize',10);
hold on
% best 4T1R MUX, VDD = 0.9V, in terms of delay
plot(mux_size_list, pdp_rram_mux_0p9V,'g-s','LineWidth', 2, 'MarkerSize',10);
hold on
